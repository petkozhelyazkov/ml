...
export default function Navigation() {
    ...
    return (
        <nav>
            <div className="space-x-6 z-20 fixed h-screen bg-gray-300">
                {open ?
                    <div onMouseLeave={() => setOpen(false)} className="open flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded" >
                        <NavigationItem>
                            ...
                            <span className="ml-2 text-sm font-bold">App</span>
                        </NavigationItem>
                        <Separator>
                            <NavigationItem>
